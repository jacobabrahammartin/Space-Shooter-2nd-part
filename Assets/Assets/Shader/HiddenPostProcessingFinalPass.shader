				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    if(u_xlatb30){
					        ...
					        u_xlatb0.x = u_xlat0.x>=u_xlat0.y;
					        u_xlat10.x = u_xlat30 * 2.0 + u_xlat2.x;
					        u_xlat30 = (u_xlatb0.x) ? u_xlat4.w : u_xlat5.w;
					        u_xlat2.x = (u_xlatb0.x) ? u_xlat2.w : u_xlat3.w;
					        u_xlat12.x = (u_xlatb0.x) ? _MainTex_TexelSize.y : _MainTex_TexelSize.x;
					        ...
					        u_xlat20 = u_xlatb0.x ? _MainTex_TexelSize.x : float(0.0);
					        u_xlat32 = (u_xlatb0.x) ? 0.0 : _MainTex_TexelSize.y;
					        u_xlat13.xy = u_xlat12.xx * vec2(0.5, 0.5) + vs_TEXCOORD0.xy;
					        u_xlat13.x = (u_xlatb0.x) ? vs_TEXCOORD0.x : u_xlat13.x;
					        u_xlat23.x = (u_xlatb0.x) ? u_xlat13.y : vs_TEXCOORD0.y;
					        ...
					        u_xlat20 = (u_xlatb0.x) ? u_xlat20 : u_xlat2.x;
					        u_xlat2.x = u_xlat6.y + (-vs_TEXCOORD0.y);
					        u_xlat30 = (u_xlatb0.x) ? u_xlat30 : u_xlat2.x;
					        ...
					        u_xlat2.x = (u_xlatb0.x) ? vs_TEXCOORD0.x : u_xlat10.x;
					        u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
					        u_xlat2.y = (u_xlatb0.x) ? u_xlat10.y : vs_TEXCOORD0.y;
					        u_xlat2.y = clamp(u_xlat2.y, 0.0, 1.0);
					        u_xlat0.xy = u_xlat2.xy * vec2(_RenderViewportScaleFactor);
					    ...
					    u_xlat10.xyz = u_xlat1.xyz * vec3(12.9200001, 12.9200001, 12.9200001);
					    u_xlat2.xyz = max(abs(u_xlat1.xyz), vec3(1.1920929e-07, 1.1920929e-07, 1.1920929e-07));
					    u_xlat2.xyz = log2(u_xlat2.xyz);
					    u_xlat2.xyz = u_xlat2.xyz * vec3(0.416666657, 0.416666657, 0.416666657);
					    u_xlat2.xyz = exp2(u_xlat2.xyz);
					    ...
					    u_xlatb1.xyz = greaterThanEqual(vec4(0.00313080009, 0.00313080009, 0.00313080009, 0.0), u_xlat1.xyzx).xyz;
					    {
					        ...
					        hlslcc_movcTemp.x = (u_xlatb1.x) ? u_xlat10.x : u_xlat2.x;
					        hlslcc_movcTemp.y = (u_xlatb1.y) ? u_xlat10.y : u_xlat2.y;
					        hlslcc_movcTemp.z = (u_xlatb1.z) ? u_xlat10.z : u_xlat2.z;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    if(u_xlatb30){
					        ...
					        u_xlatb0.x = u_xlat0.x>=u_xlat0.y;
					        u_xlat10.x = u_xlat30 * 2.0 + u_xlat2.x;
					        u_xlat30 = (u_xlatb0.x) ? u_xlat4.y : u_xlat5.y;
					        u_xlat2.x = (u_xlatb0.x) ? u_xlat2.y : u_xlat3.y;
					        u_xlat12 = (u_xlatb0.x) ? _MainTex_TexelSize.y : _MainTex_TexelSize.x;
